...
<head>
 ...
 ============================================= -->
    ...
    <link rel="shortcut icon"
        href="@if (View::hasSection('icon')) @yield('icon')@else
        {!! asset('webpage/demos/marsiajar/logo.ico') !!} @endif"
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-241163449-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
      ...
      ============================================= -->
                        <div class="top-links">
                            <ul class="top-links-container">
                                ...
                                <li class="top-links-item"><a href="/{{ $token }}/register">Mulai berbagi</a>
                                </li>
                            </ul>
                        </div><!-- .top-links end -->
                    ...
                    <div class="col-12 col-md-auto ps-0">
                        ...
                        <ul id="top-social">
                            ...
                            <li><a href="https://wa.me/6285159935864" class="si-call" target="_blank"><span
                                        class="ts-icon"><i class="icon-call"></i></span><span
                                        class="ts-text">+62851599358648</span></a>
                            </li>
  ...
  ============================================= -->
            ...
            <div class="container">
                <div class="header-row">
                    ...
                    <nav class="navbar navbar-expand-lg p-0 m-0 w-100">
                        <div id="logo">
                            <a href="/" class="standard-logo"><img src="{!! asset('webpage/demos/marsiajar/logo_long.png') !!}"
                                    alt="Marsiajar Logo"></a>
                            <a href="/" class="retina-logo"><img src="{!! asset('webpage/demos/marsiajar/logo_long.png') !!}"
                                    alt="Marsiajar Logo"></a>
                        </div>
                    </nav>
       ...
       ============================================= -->
                            <div id="top-search" class="header-misc-icon">
                                <a href="{{ config('app.application_based') }}" id=""
                                    style="width:auto !important;"><i class="icon-sign-in-alt"
                                        style="left: -25px;"></i> Sign In</a>
                            </div><!-- #top-search end -->
                        </div>
                                    ...
                                    <ul class="sub-menu-container">
                                        ...
                                        @if (!$getCategories->isEmpty())
                                            @foreach ($getCategories as $item)
                                                <li class="menu-item"><a class="menu-link"
                                                        href="/educative/{{ $item->slug }}">
                                                        <div><i
                                                                class="icon-chart-bar1"></i>{{ $item->categories_name }}
                                                        </div>
                                                    </a>
                                                </li>
                                            @endforeach
                ...
                <div class="footer-widgets-wrap">
                    ...
                    <div class="row">
                        <div class="col-6 col-md-6"
                            style="background: url('webpage/images/world-map.png') no-repeat center center;
                    background-size: 100%;">
                            <img class="mb-3" src="{!! asset('webpage/demos/marsiajar/Logo-white.png') !!}"
                                alt="
                                Marsiajar logo" width="160">
                            <?php $y = date('Y'); ?>
                            <small class="d-block mb-4 text-muted">&copy; marsiajar.com
                                2022-{{ $y }}</small>
                            <p class="text-white-50" style="font-size: 16px;">Marsiajar merupakan sebuah komunitas
                                Mari
                            ...
                            <a href="mailto:info@marsiajar.com"><i
                                    class="icon-line2-envelope me-2"></i>info@marsiajar.com</a>
                        </div>
                        <div class="col-6 col-md-3">
                            @php
                                $getPopularClass = DB::table('blogs')
                        ...
                        <div class="col-6 col-md-3 col-sm mt-4 mt-md-0 mt-lg-0 mt-xl-0">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li>
                                    <h5 class="mb-2 fw-normal"><a href="/{{ $token }}/register">Become an
                                            educators</a>
                                    </h5>
                                </li>
                                <li>
